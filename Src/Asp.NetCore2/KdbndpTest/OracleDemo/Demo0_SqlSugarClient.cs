    ...
    public class Demo0_SqlSugarClient
    {
        ...
        private static void SqlSugarClient()
        {
           ...
           // db.Open();
            ...
            //Use db ado
            var dt = db.Ado.ExecuteCommand(" CREATE EXTENSION IF NOT EXISTS kbcrypto;CREATE EXTENSION IF NOT EXISTS \"uuid-ossp\"");
        ...
        private static void DistributedTransactionExample()
        {
            ...
            {
                new ConnectionConfig(){ ConfigId="1", DbType=DbType.Kdbndp, ConnectionString=Config.ConnectionString,InitKeyType=InitKeyType.Attribute,IsAutoCloseConnection=true },
                new ConnectionConfig(){ ConfigId="2", DbType=DbType.Kdbndp, ConnectionString=Config.ConnectionString2 ,InitKeyType=InitKeyType.Attribute ,IsAutoCloseConnection=true}
            });
