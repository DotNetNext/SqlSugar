...
{
    public class TDSQLForOracleODBCProvider : AdoProvider
    {
        public override string SqlParameterKeyWord { get { return ":"; } }
        public TDSQLForOracleODBCProvider() { }
        ...
        {
            return new TDSQLForOracleDataAdapter();
        }
        public override DbCommand GetCommand(string sql, SugarParameter[] parameters)
        {
            var helper = new TDSQLForOracleODBCInsertBuilder();
        ...
        {
            ((TDSQLForOracleDataAdapter)dataAdapter).SelectCommand = (OdbcCommand)command;
        }
        /// <summary>
