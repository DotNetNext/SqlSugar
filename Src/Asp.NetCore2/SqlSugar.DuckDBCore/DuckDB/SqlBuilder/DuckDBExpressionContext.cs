...
{
    public class DuckDBExpressionContext : ExpressionContext, ILambdaExpressions
    {
        public SqlSugarProvider Context { get; set; }
        public DuckDBExpressionContext()
        {
    ...
    public class DuckDBMethod : DefaultDbMethod, IDbMethods
    {
