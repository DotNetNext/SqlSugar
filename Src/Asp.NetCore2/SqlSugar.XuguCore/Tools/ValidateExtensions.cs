...
namespace SqlSugar.Xugu
{
    ...
    {
        public static bool IsInRange(this int thisValue, int begin, int end)=> thisValue >= begin && thisValue <= end;

        public static bool IsInRange(this DateTime thisValue, DateTime begin, DateTime end)=> thisValue >= begin && thisValue <= end;

        public static bool IsIn<T>(this T thisValue, params T[] values)=> values.Contains(thisValue);

        public static bool IsContainsIn(this string thisValue, params string[] inValues)=>inValues.Any(it => thisValue.Contains(it));
        ...
        public static bool IsZero(this object thisValue) => (thisValue == null || thisValue.ToString() == "0");
        ...
        public static bool IsStringArray(this string thisValue)=> (thisValue + "").IsMatch(@"System\.[a-z,A-Z,0-9]+?\[\]");
        public static bool IsEnumerable(this string thisValue)=> (thisValue + "").StartsWith("System.Linq.Enumerable");

        public static Type StringType = typeof (string);

        public static bool IsClass(this Type thisValue)=> thisValue != StringType && thisValue.IsEntity() && thisValue != UtilConstants.ByteArrayType;
    }
}
