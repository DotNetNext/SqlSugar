...
namespace OrmTest
{
    public class Demo0_SqlSugarClient
    {
        ...
        private static void DistributedTransactionExample()
        {
            ...
            {
                new ConnectionConfig(){ ConfigId="1", DbType=DbType.Oscar, ConnectionString=Config.ConnectionString,InitKeyType=InitKeyType.Attribute,IsAutoCloseConnection=true },
                new ConnectionConfig(){ ConfigId="2", DbType=DbType.Oscar, ConnectionString=Config.ConnectionString2 ,InitKeyType=InitKeyType.Attribute ,IsAutoCloseConnection=true}
            });
