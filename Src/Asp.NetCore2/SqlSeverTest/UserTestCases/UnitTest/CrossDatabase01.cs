...
namespace OrmTest
{
    public class CrossDatabase01
    {
        public static void Init()
        {
            ...
            {
                new ConnectionConfig(){ConfigId="OrderDb",DbType=DbType.SqlServer,ConnectionString="server=.;uid=sa;pwd=sasa;database=SQLSUGAR4XTEST;Encrypt=True;TrustServerCertificate=True",IsAutoCloseConnection=true},
