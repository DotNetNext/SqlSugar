...
namespace SqlSugar
{
    public class OpenGaussExpressionContext : ExpressionContext, ILambdaExpressions
    {
        public SqlSugarProvider Context { get; set; }
        public OpenGaussExpressionContext()
        {
            base.DbMehtods = new OpenGaussMethod();
        }
    ...
    public class OpenGaussMethod : DefaultDbMethod, IDbMethods
    {
