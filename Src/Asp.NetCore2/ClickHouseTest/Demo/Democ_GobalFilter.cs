...
namespace OrmTest
{
    public class DemoC_GobalFilter
    {
        ...
        {
            SqlSugarClient db = new SqlSugarClient(new ConnectionConfig() { DbType = DbType.ClickHouse, ConnectionString = Config.ConnectionString, IsAutoCloseConnection = true });
