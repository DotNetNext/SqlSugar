...
{
    public class MongoDbFastBuilder : FastBuilder, IFastBuilder
    {
        public async Task<int> ExecuteBulkCopyAsync(DataTable dt)
        {
            ...
            await BulkInsertToMongoDb((MongoDbConnection)this.Context.Ado.Connection, dt.TableName, dt, this.Context.Ado.IsNoTran());
            return dt.Rows.Count;
        }
        public async Task BulkInsertToMongoDb(MongoDbConnection conn, string tableName, DataTable table, bool isTran)
        {
