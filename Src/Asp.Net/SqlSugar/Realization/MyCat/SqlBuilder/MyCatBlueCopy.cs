...
namespace SqlSugar
{
    public class MyCatBlueCopy<T> 
    {
        internal SqlSugarProvider Context { get; set; }
        internal ISqlBuilder Builder { get; set; }
        internal T[] Entitys { get; set; }
        internal string Chara { get; set; }
        private MyCatBlueCopy()
        {

        }
        public MyCatBlueCopy(SqlSugarProvider context, ISqlBuilder builder, T []entitys)
        {
        ...
        public bool ExecuteBlueCopy()
        {
            ...
            MyCatConnection conn = this.Context.Ado.Connection as MyCatConnection;
            try
            {
                this.Context.Ado.Open();
                // IsolationLevel.Parse
                MyCatBulkLoader bulk = new MyCatBulkLoader(conn)
                {
