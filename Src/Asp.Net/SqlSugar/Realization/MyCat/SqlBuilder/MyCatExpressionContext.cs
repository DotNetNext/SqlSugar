...
namespace SqlSugar
{
    public class MyCatExpressionContext : ExpressionContext, ILambdaExpressions
    {
        public SqlSugarProvider Context { get; set; }
        public MyCatExpressionContext()
        {
            base.DbMehtods = new MyCatMethod();
        }
        public override string SqlTranslationLeft { get { return "`"; } }
        public override string SqlTranslationRight { get { return "`"; } }
    }
    public class MyCatMethod : DefaultDbMethod, IDbMethods
    {
